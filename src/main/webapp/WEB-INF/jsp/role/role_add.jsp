        ...
        <div class="col-sm-7 column">
            <form id="uploadForm" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="roleName" name="roleName" value="" placeholder="君の名は。">
                </div>
                <div class="form-group">
                    <label for="roleInfo">详情</label>
                    <input type="text" class="form-control" id="roleInfo" name="roleInfo" value="" placeholder="详情">
                </div>
