...
</ul><h2 id="项目经历"><a class="anchor hidden-xs" href="#项目经历" title="项目经历"><span class="octicon octicon-link"></span></a>项目经历</h2><h3 id="starry-博客系统"><a class="anchor hidden-xs" href="#starry-博客系统" title="starry-博客系统"><span class="octicon octicon-link"></span></a>Starry 博客系统</h3><p>Code &amp; Demo: <a href="https://github.com/aimkiray/starry" target="_blank">https://github.com/aimkiray/starry</a></p><blockquote>
...
</ul><h3 id="sgroup-订单管理系统"><a class="anchor hidden-xs" href="#sgroup-订单管理系统" title="sgroup-订单管理系统"><span class="octicon octicon-link"></span></a>Sgroup 订单管理系统</h3><p>Code: <a href="https://github.com/aimkiray/sgroup" target="_blank">https://github.com/aimkiray/sgroup</a></p><blockquote>
<p>本人第一个 Java Web 项目，为巩固基础而作。在此过程中本人充分练习了 Java 常用的设计模式和 J2EE 基本知识，熟悉了 MVC 架构，初步学习了 ES5 语法以及 HTML5 和 CSS3 常用标签属性，并加强了独立解决问题的能力。项目已完成，主要特点如下。</p>
</blockquote><ul>
...
</ul><h3 id="starry-gallery-资源管理系统"><a class="anchor hidden-xs" href="#starry-gallery-资源管理系统" title="starry-gallery-资源管理系统"><span class="octicon octicon-link"></span></a>Starry-gallery 资源管理系统</h3><p>Code: <a href="https://github.com/aimkiray/starry-gallery" target="_blank">https://github.com/aimkiray/starry-gallery</a></p><blockquote>
...
<li><strong>Java</strong>：熟悉 Java 语法，编码规范，见名知意；了解 util 包下常用工具类，了解常用集合框架的原理并能熟练使用；了解 Java 的泛类和反射机制，以此写过 Service 父类实现通用 CRUD；熟悉 I/O 流和异常处理，了解多线程和同步机制；会用 Java 实现经典算法（面向 Google）</li>
<li><strong>网页</strong>：熟悉 HTML5 常用标签和属性；熟悉 CSS 常用属性语法，熟练使用原生 CSS 定位元素，了解 CSS3 动画</li>
<li><strong>JavaScript</strong>：了解 ES5，熟悉原生 DOM 操作；熟悉类型转换，比如 Object 类型和 JSON 字符串互转；用过原生 Ajax 实现文件上传；<s>精通 Node.js 的 Hello World 写法 XD</s>（正式版见 PDF）</li>
...
<li><strong>系统</strong>：超过 3 年 Linux 使用经验</li>
<li><strong>其他</strong>：<s>擅长修电脑</s>；写过 Python &amp; Shell 脚本</li>
...
<li>乐于自学，边学边用，擅长搜寻并独立解决问题</li>
<li>不受限于语言，无论 Python，Go 还是 Node.js，只要工作需要就能快速上手</li>
<li>伪完美主义者，但有时也会为了项目快速上线而 play hard XD</li>
    ...
    <div class="ui-toc dropup unselectable hidden-print" style="display:none;">
        <div class="pull-right dropdown">
            ...
            <ul id="ui-toc" class="ui-toc-dropdown dropdown-menu" aria-labelledby="tocLabel">
                <div class="toc"><ul class="nav"><li class=""><a href="#联系方式">联系方式</a></li><li><a href="#个人信息">个人信息</a></li><li><a href="#项目经历">项目经历</a><ul class="nav"><li><a href="#starry-博客系统">Starry 博客系统</a></li><li><a href="#sgroup-订单管理系统">Sgroup 订单管理系统</a></li><li><a href="#starry-gallery-资源管理系统">Starry-gallery 资源管理系统</a></li></ul></li><li><a href="#技能">技能</a></li><li><a href="#获奖情况">获奖情况</a></li><li><a href="#自我评价">自我评价</a></li></ul></div><div class="toc-menu"><a class="expand-toggle" href="#">Expand all</a><a class="back-to-top" href="#">Back to top</a><a class="go-to-bottom" href="#">Go to bottom</a></div>
            </ul>
        </div>
    </div>
